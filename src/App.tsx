...
import sidd from "/sidd.jpg";

import heroEye from "@/assets/devil.jpeg";
...
const logos = ["SIDDHESH", "BIMBO", "VLSI", "DEVELOPER"];
...
export default function App() {
  ...
  const colors = [
    "bg-gradient-to-b from-white via-gray-100 via-gray-400 to-black text-transparent bg-clip-text",
    "text-white",
    "bg-gradient-to-b from-black via-gray-400 via-gray-100 to-white text-transparent bg-clip-text",
  ];
        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 backdrop-blur-xl bg-black/20 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[90px] md:text-xs tracking-[0.3em] text-white/70 uppercase font-medium">
                SIDDHESH P. TUPE 
              </span>
            </div>
...
animate-[shine_4s_linear_infinite]">
    ...
    animate-[shine_4s_linear_infinite]">
                ...
                <a
                  href="https://theclipflow.netlify.app/"
                  target="_blank"
