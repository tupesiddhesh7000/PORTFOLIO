...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Crafting digital experiences powered by engineering and innovation .
          "Where technology speaks, innovation begins."
        </motion.p>
        ...
        >
          {["Digital Electronics", "Arduino", "Analog Circuits", "PCB"].map((tech) => (
            <div
              key={tech}
              className="
